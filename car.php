    ...
    <div class="section">
        ...
        <div class="viewer-wrap">
            ...
            <?php if (!empty($car['model_3d'])): ?>
                <?php
                // v DB očekáváme (cestu k modelu)
                $modelUrl = $baseUrl . $car['model_3d'];
                ?>
                <model-viewer
                    src="<?php echo htmlspecialchars($modelUrl, ENT_QUOTES, 'UTF-8'); ?>"
        ...
        <div class="grid2">
            ...
            <div class="section">
                ...
                <?php else: ?>
                    <p class="muted" style="margin:0;">
                        Zatím bez popisu.
                        (Doporučení: přidej do DB sloupec <code>description</code> a vyplň u aut popis.)
                    </p>
                <?php endif; ?>
